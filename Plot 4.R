...
# Set up a 2 by 2 frame for graphs, and the margin as (Bottom =4, Left=4,Up=2, Right=2)
...
# Bottom right plot
plot(elec_power$Time, elec_power$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "Datetime")
