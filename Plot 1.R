...
# Plot the histgram of the frequency of variable Global Active Power
png(filename = "Plot 1.png", width = 480, height = 480, units = "px")
hist(elec_power$Global_active_power, freq = TRUE, xlab = "Global Active Power (Kilowatts)", main = "Global Active Power", ylab = "Frequency", col = "red")
dev.off()
